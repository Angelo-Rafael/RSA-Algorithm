...
In my code, I tried to follow the algorithm's logic scheme, without copying from other codes, only with studies of the calculation process necessary to obtain the encryption and decryption. I applied this process to a message, so my code takes a message, encrypts and decrypts it. 
...
No meu código, eu tentei seguir o esquema de lógica do algoritmo, sem copiar de outros códigos, somente com estudos do processo de cálculo necessário para obter a encriptação e decriptação. Apliquei esse processo em uma mensagem, então o meu código à recebe, encriptografa e descriptografa.
